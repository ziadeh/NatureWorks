...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    role: Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    isJudge: Attribute.Boolean & Attribute.DefaultTo<true>;
    regions: Attribute.Relation<
      'plugin::users-permissions.user',
      'manyToMany',
      'api::region.region'
    >;
    viewLastStep: Attribute.Boolean;
    viewPreviousStep: Attribute.Boolean;
    startup_assessments: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToMany',
...
export interface ApiAssessmentAssessment extends Schema.CollectionType {
  ...
  attributes: {
    ...
    step: Attribute.Enumeration<['Local contest', 'Regional contest']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiGlobalGlobal extends Schema.SingleType {
  ...
  attributes: {
    ...
    competitionLocalOpen: Attribute.Boolean;
    competitionRegionalOpen: Attribute.Boolean;
    openViewToJudges: Attribute.Boolean;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::global.global',
...
export interface ApiStartupStartup extends Schema.CollectionType {
  ...
  attributes: {
    ...
    startup_assessments: Attribute.Relation<
      ...
      'api::startup-assessment.startup-assessment'
    >;
    startup_scores: Attribute.Relation<
      'api::startup.startup',
      'oneToMany',
...
export interface ApiStartupAssessmentStartupAssessment
  extends Schema.CollectionType {
  ...
  attributes: {
    ...
    questionScore: Attribute.Component<'shared.question-score', true>;
    lockedForm: Attribute.Boolean & Attribute.DefaultTo<true>;
    ...
    judge: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    startup_score: Attribute.Relation<
      'api::startup-assessment.startup-assessment',
      'manyToOne',
      'api::startup-score.startup-score'
    >;
...
export interface ApiStartupScoreStartupScore extends Schema.CollectionType {
  ...
  attributes: {
    ...
    localContestWinner: Attribute.Boolean & Attribute.DefaultTo<false>;
    startup: Attribute.Relation<
      'api::startup-score.startup-score',
      'manyToOne',
      'api::startup.startup'
    ...
    startup_assessments: Attribute.Relation<
      ...
      'api::startup-assessment.startup-assessment'
    >;
    regionalContestWinner: Attribute.Boolean & Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::startup-score.startup-score',
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::startup-assessment.startup-assessment': ApiStartupAssessmentStartupAssessment;
      'api::startup-score.startup-score': ApiStartupScoreStartupScore;
    }
  }
}
